...
__weak void  App_OS_TaskCreateHook (OS_TCB  *p_tcb)
{
    (void)&p_tcb;
}
...
__weak void  App_OS_TaskDelHook (OS_TCB  *p_tcb)
{
    (void)&p_tcb;
}
...
__weak void  App_OS_TaskReturnHook (OS_TCB  *p_tcb)
{
    (void)&p_tcb;
}
...
__weak void  App_OS_IdleTaskHook (void)
{
...
__weak void  App_OS_InitHook (void)
{
...
__weak void  App_OS_StatTaskHook (void)
{
...
__weak void  App_OS_TaskSwHook (void)
{
...
__weak void  App_OS_TimeTickHook (void)
{
